...
# end
# 
# hybris_app_service "start hybris server" do
  # appServerDirectory "#{localAppDirectory}"
  # action :start
# end

node.set['hybris']['clusterID'] = "1"

hybris_app_clusterID "set clusterID" do
  appServerDirectory "#{localAppDirectory}"
  clusterID "#{node['hybris']['clusterID']}"
  createBackup false
  action :set
end
